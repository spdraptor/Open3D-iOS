...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(name: "libOpen3D_3rdparty_liblzf.a", path: "artifacts/libOpen3D_3rdparty_liblzf.a.xcframework"),
        ...
        .binaryTarget(name: "pybind.a", path: "artifacts/pybind.a.xcframework"),
